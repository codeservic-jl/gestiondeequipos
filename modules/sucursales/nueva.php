...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        $stmt = $conn->prepare("INSERT INTO sucursales (nombre, direccion, telefono, estado) VALUES (?, ?, ?, ?)");
        $stmt->execute([
            $_POST['nombre'],
            $_POST['direccion'],
            $_POST['telefono'],
...
<head>
    ...
    <title>Nueva Sucursal - Gestión de Equipos RGE</title>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-2xl font-bold text-navy-blue mb-6">Nueva Sucursal</h2>
